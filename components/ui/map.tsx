...
export function WorldMap({
    dots = [],
    lineColor = "#737373", // Using monochrome primary from theme
    showLabels = true,
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="flex items-center justify-center h-full">
                                                <span className="text-[10px] font-medium px-2 py-0.5 rounded-md bg-white/95 dark:bg-black/95 text-black dark:text-white border border-gray-200 dark:border-gray-700 shadow-sm">
                                                    {dot.start.label}
                                                </span>
                                            </div>
                                        </foreignObject>
